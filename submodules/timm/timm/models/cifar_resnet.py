...
from shared.modules.factories import get_conv_factory, get_noise_factory, get_norm_factory, get_linear_factory, get_activation_factory
...
class ResNet(nn.Module):
    def __init__(self, *,
        ...
        dropout_factory = get_noise_factory(block_dropout_cfg) if block_dropout_cfg else None
