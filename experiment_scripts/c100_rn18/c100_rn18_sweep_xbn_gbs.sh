# Sweep XBN GBS, 3 seeds, 90%/10% train/val split
# Assume BASE_DIR is ../../
...
do
    ...
    do
        ...
        --log-wandb --wandb-kwargs project=$wandb_project name="\"c100-rn18-b256-sweep-xbn-gbs$gbs-s$seed\"" 'tags=["c100_rn18_b256_sweep_xbn"]' --seed $seed
    done
done
