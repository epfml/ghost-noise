# Sweep XBN GNI GBS, 3 seeds, 90%/10% train/val split
# Assume BASE_DIR is ../../
...
do
    ...
    do
        ...
        --model cifar_resnet --model-kwargs 'input_block=cifar' 'block_name=basicblock' 'stage_depths=[2,2,2,2]' norm_cfg="[{\"type\":\"norm\",\"subtype\":\"xbn2d\",\"dkwargs\":{\"affine\":False}},{\"type\":\"noise\",\"subtype\":\"ghost_noise_injector_rep\",\"dkwargs\":{\"batch_size\":$gbs}},{\"type\":\"gain\",\"subtype\":\"standard\"},{\"type\":\"bias\",\"subtype\":\"standard\"}]" \
        ...
        --log-wandb --wandb-kwargs project=$wandb_project name="\"c100-rn18-b256-sweep-xbn-gnir-gbs$gbs-s$seed\"" 'tags=["c100_rn18_b256_sweep_xbn_gnir"]' --seed $seed
    done
done