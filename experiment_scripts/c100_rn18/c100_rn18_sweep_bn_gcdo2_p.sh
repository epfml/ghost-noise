...
do
    ...
    do
        ...
        --model cifar_resnet --model-kwargs 'input_block=cifar' 'block_name=basicblock' 'stage_depths=[2,2,2,2]' norm_cfg="bn2d" block_dropout_cfg="{\"type\":\"noise\",\"subtype\":\"flexible_dropout\",\"dkwargs\":{\"drop_probability\":$p,\"noise_type\":\"gaussian\",\"channel_wise\":True,\"scaling_type\":\"mean\"}}" \
        ...
        --log-wandb --wandb-kwargs project=$wandb_project name="\"c100-rn18-b256-sweep-bn-gcdo2-p$p-s$seed\"" 'tags=["c100_rn18_b256_sweep_bn_gcdo2"]' --seed $seed
    done
done
