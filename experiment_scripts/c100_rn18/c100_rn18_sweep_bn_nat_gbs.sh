...
do
    ...
    do
        ...
        --model cifar_resnet --model-kwargs 'input_block=cifar' 'block_name=basicblock' 'stage_depths=[2,2,2,2]' norm_cfg="[{\"type\":\"norm\",\"subtype\":\"bn2d\",\"dkwargs\":{\"affine\":False}},{\"type\":\"noise\",\"subtype\":\"nat\",\"dkwargs\":{\"batch_size\":$gbs,\"scale_shift\":False,\"shift_noise\":True,\"scale_noise\":True}},{\"type\":\"gain\",\"subtype\":\"standard\"},{\"type\":\"bias\",\"subtype\":\"bias\"}]" \
        ...
        --log-wandb --wandb-kwargs project=$wandb_project name="\"c100-rn18-b256-sweep-bn-nat-gbs$gbs-s$seed\"" 'tags=["c100_rn18_b256_sweep_bn_nat"]' --seed $seed
    done
done
